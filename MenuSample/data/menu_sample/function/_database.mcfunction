...
data modify storage menu: database append value {Page:0,type:"setting",columns:2,esc_close:true,title:{nbt:"_sample_text",storage:"menu_sample:",interpret:true}}
data modify storage menu: database append value {Page:0,type:"button",label:{nbt:"_sample_text",storage:"menu_sample:",interpret:true},tooltip:{text:"サンプルツールチップ"},width:100,action:{type:"run_command",value:"function menu_sample:_sample_function",close:true}}
data modify storage menu: database append value {Page:0,type:"button",label:{text:"だいなみっくこまんど"},tooltip:{text:"サンプルツールチップ"},width:100,action:{type:"dynamic/run_command",value:'$(a)',close:true}}
...
data modify storage menu: database append value {Page:0,type:"input_text",key:"a",width:200,init:{from_storage:"menu_sample: _sample_input_text"}}
...
data modify storage menu: database append value {Page:1,type:"button",label:{nbt:"_sample_text",storage:"menu_sample:",interpret:true},tooltip:{text:"サンプルツールチップ"},width:100,action:{type:"run_command",value:"function menu_sample:_sample_function",close:true}}
data modify storage menu: database append value {Page:1,type:"button",label:{text:"ページ2へ遷移"},width:350,action:{type:"page_change",value:2,close:false}}
...
data modify storage menu: database append value {Page:2,type:"setting",columns:1,esc_close:true,title:{nbt:"_sample_text",storage:"menu_sample:",interpret:true}}
data modify storage menu: database append value {Page:2,type:"button",label:{text:"ページ0へ戻る"},width:250,action:{type:"page_change",value:0,close:false}}
data modify storage menu: database append value {Page:2,type:"exit_button",label:{text:"ページ1へ戻る"},width:250,action:{type:"page_change",value:1,close:false}}
