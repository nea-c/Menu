...
data modify storage menu: database append value {Page:0,type:"input_num",label:{nbt:"_sample_text",storage:"menu_sample:",interpret:true},key:"a",width:200,init:{from_storage:"menu_sample: _sample_int"},start:0,end:100,step:1}
